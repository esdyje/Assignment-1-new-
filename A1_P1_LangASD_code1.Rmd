...
```{r message=FALSE}
setwd("~/OneDrive - Aarhus universitet/AU-Cognitive Science/3rd Semester/Experimental Methods 3/Exercise/Assignments/Assignment 1 new")
library(stringr);library(tidyverse);library(plyr);library(dplyr);library(magrittr)
